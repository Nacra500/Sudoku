...
class TestXSudokuGameFieldGenerator {

	XSudokuGameFieldGenerator game;
	SudokuField field;
	...
	void setUp() throws Exception {
		...
		game = new XSudokuGameFieldGenerator(field);
	...
	@Test
	void testCheckForObviousDiagonal() {
		assertFalse(game.checkForObviousDiagonal(3, 3,7));
		assertTrue(game.checkForObviousDiagonal(6, 2,5)); 
	}
